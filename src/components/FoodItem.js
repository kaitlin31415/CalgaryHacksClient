    ...
    return (
      <div id="FoodItem">
        ...
        <section className="one-fourth" id="html">
            <img id="foodpic" src={this.state.img} />
            </section>
            <h1 class="fooditemfont">{this.state.name}</h1>
        </div>
        ...
        <div id="ItemPrice">
        <h1 class="fooditemfont">${this.state.price}</h1>
        </div>
        ...
        <h1 class="fooditemfont">{this.state.restaurant}</h1>
        </div>
        ...
        <div id="LocationName">
        <h1 class="fooditemfont">{this.state.location}</h1>
        </div>
        ...
        <h1 class="fooditemfont">{this.state.calories} cal</h1>
        </div>
        </div>
